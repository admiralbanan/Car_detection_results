...
#### 4.3 Гистограмма количества ошибок на видео
...
#### 4.4 Probability Plot (Q-Q Plot) — проверка нормальности распределения ошибок
![Q-Q Plot ошибок](results/probabilty.jpg)

**Анализ**:  
- **Центральная часть** (до ±20 ошибок) — **линейная**, ошибки распределены **почти нормально**  
- **Хвосты отклоняются**:  
  - **Левый**: меньше ожидаемого — мало видео с отрицательным числом ошибок (очевидно)  
